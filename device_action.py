...
async def _reset_filter(ip: str, parameters: dict) -> None:
...
DEVICE_ACTIONS = {
    ...
    "set_device_name": {
        ...
        "parameters": {
            "name": {"type": "string", "max_length": 32, "required": True}
        }
    },
    "set_network_config": {
        ...
        "parameters": {
            ...
            "password": {"type": "string", "min_length": 8, "max_length": 32, "required": True}
        }
    }
}

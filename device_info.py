...
from .device_registry import async_get_device_unique_id
...
class VmcHeltyEntity(Entity):
    ...
    def device_info(self) -> DeviceInfo:
        ...
        unique_id = self._device_info.get("unique_id") or f"helty_flow_{self.coordinator.ip.replace('.', '_')}"
    ...
    @property
    def name_by_user(self) -> Optional[str]:

...
from .helpers import tcp_send_command, parse_vmsl_response
    ...
    async def async_press(self) -> None:
        ...
        try:
            response = await tcp_send_command(
                self.coordinator.ip, 5001, "VMWH0417744"
            )
            if response == "OK":

...
class VmcHeltySensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_{sensor_key}"
...
class VmcHeltyAirflowSensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_airflow"
...
class VmcHeltyOnOffSensor(VmcHeltyEntity, BinarySensorEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_online"
...
class VmcHeltyLastResponseSensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_last_response"
...
class VmcHeltyFilterHoursSensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_filter_hours"
...
class VmcHeltyIPAddressSensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_ip_address"
...
class VmcHeltyResetFilterButton(VmcHeltyEntity, ButtonEntity):
    ...
    def __init__(self, coordinator):
        ...
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_reset_filter"
...
class VmcHeltyNameText(VmcHeltyEntity, TextEntity):
    ...
    def __init__(self, coordinator):
        ...
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_device_name"
...
class VmcHeltySSIDText(VmcHeltyEntity, TextEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the text entity."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_wifi_ssid"
...
class VmcHeltyPasswordText(VmcHeltyEntity, TextEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the text entity."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_wifi_password"
...
class VmcHeltyAbsoluteHumiditySensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_absolute_humidity"
...
class VmcHeltyDewPointSensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_dew_point"
...
class VmcHeltyComfortIndexSensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(self, coordinator: VmcHeltyCoordinator) -> None:
        ...
        self._attr_unique_id = f"{coordinator.device_id}_comfort_index"
        self._attr_state_class = SensorStateClass.MEASUREMENT
...
class VmcHeltyDewPointDeltaSensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(self, coordinator):
        ...
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_dew_point_delta"
...
class VmcHeltyAirExchangeTimeSensor(VmcHeltyEntity, SensorEntity):
    ...
    def __init__(self, coordinator):
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._attr_unique_id = f"vmc_{coordinator.name_slug}_air_exchange_time"
...
class VmcHeltyDailyAirChangesSensor(SensorEntity):
    ...
    def __init__(self, coordinator: VmcHeltyCoordinator, device_id: str) -> None:
        ...
        self._attr_unique_id = f"{device_id}_daily_air_changes"
